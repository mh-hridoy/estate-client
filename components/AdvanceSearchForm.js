...
const AdvanceSearchForm = ({ advanceSearch, limitChange, onReset, isLoading, advanceForm }) => {
    const { Item } = Form
    const { Option } = Select


    return (
        <Form form={advanceForm} layout="vertical" className={styles.searchForm} onFinish={advanceSearch} initialValues={{ limit: "10" }}  >
