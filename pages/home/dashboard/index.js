    ...
    return (
        <ProtectedPage>
            ...
            <div className="cardContainer">
                ...
                <Card icon={< NotificationOutlined />} title="Show Alarm" description="Click here to check all your set Alarmed properties that you marked on this site." />
                <Card icon={< LineChartOutlined />} title="Report" description="Click here to check reports ." />
                <Card icon={< LineChartOutlined />} title="AA Report" description="Click here to check reports AA reports ." />
