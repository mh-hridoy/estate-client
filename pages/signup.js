...
const Signup = () => {
  ...
  const [requestedPathname] = useState(
    useSelector((state) => state.user.requestedPath)
  );
    ...
    if (clickedOnLogin && loginData) {
      const loginHandler = async () => {
        try {
          ...
          const route =
            requestedPathname != "" ? requestedPathname : "/home/dashboard";
          router.push(route);
  ...
  const registerAccount = async ({
    ...
    try {
      ...
      message.error(
        err.response.data.message ||
          "Please provide the correct data & try again."
      );
    }
  };
              ...
              <div className={styles.ousrServices}>
                ...
                <div className={styles.serviceList}>
                  <ul>
                    <li>
                      {" "}
                      <DollarOutlined /> <strong> Money Lenders </strong>{" "}
                    </li>
                    <li>
                      {" "}
                      <ShoppingCartOutlined /> <strong>
                        {" "}
                        Fix & Flip{" "}
                      </strong>{" "}
                    </li>
                    <li>
                      {" "}
                      <HomeOutlined /> <strong> Distressed Properties </strong>
                    </li>
                    <li>
                      {" "}
                      <UnorderedListOutlined />{" "}
            ...
            <div className={styles.ousrServices}>
              ...
              <div className={styles.serviceList}>
                <ul>
                  ...
                  <li>
                    {" "}
                    <ShoppingCartOutlined /> <strong> Fix & Flip </strong>{" "}
                  </li>
                  <li>
                    {" "}
                    <HomeOutlined /> <strong> Distressed Properties </strong>
